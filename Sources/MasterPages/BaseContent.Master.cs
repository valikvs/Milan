namespace VSS.Milan.Web.MasterPages
{
    ...
    public partial class BaseContent : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var title = CurrentNode.Property(Constants.BaseContent.PageBrowserTitle);
            this.pageTitle.Text = !string.IsNullOrEmpty(title) ? title : CurrentNode.Name;

            var keywords = CurrentNode.Property(Constants.BaseContent.MetaKeywords);
            ...
            var description = CurrentNode.Property(Constants.BaseContent.MetaDescription);
